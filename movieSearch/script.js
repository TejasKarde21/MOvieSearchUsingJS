...
//https://www.omdbapi.com/?apikey=9fcda3c4&s/search/&type=movie&page=1 //omdb
 const newArr= [];
    ...
    newArr.push(...mergedArray);
     ...
     console.log(newArr);
        ...
        newArr.map(ele => {
            container.innerHTML +=`
            <a id="cha"
             onclick="moviedeatils(${ele.id})" href="./info.html">
            <div id="card">
...
function moviedeatils(id) {
    const clickedMovie = newArr.find(movie => movie.id === id);
